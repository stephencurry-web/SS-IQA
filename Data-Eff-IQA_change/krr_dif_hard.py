...
from examplar import get_A_examplar, get_B_examplar, get_mnemonics, get_random_examplar
...
def main(config, i):
    ...
    examplar_total = get_A_examplar(examplar_total, dataset_train_A, data_loader_train_ex1, t_model, config.DATA.EXAMPLAR_STEP, logger)
    ...
    for slice_num in range(config.DATA.SLICE_NUMBER):
        ...
        pseudo_label_data = get_krr_label(t_model, data_loader_train_ex1, len(dataset_train_A),
        ...
        for epoch in range(config.TRAIN.START_EPOCH_STU1, config.TRAIN.EPOCHS_STU1):
            ...
            srcc_2_a = 0.0
            plcc_2_a = 0.0
            if dist.get_rank() == 0 and epoch == config.TRAIN.EPOCHS_STU1 - 1:
        ...
        if slice_num < config.DATA.SLICE_NUMBER-1:
            ...
            pseudo_label_data_examplar = get_krr_label(t_model, data_loader_train_ex1, len(dataset_train_A),
            ...
            examplar_total = get_A_examplar(examplar_total, pseudo_label_data_examplar, data_loader_train_ex2, t_model, config.DATA.EXAMPLAR_STEP1, logger)
            ...
            del dataset_train2
            del pseudo_label_data_examplar
            del data_loader_train_ex2
