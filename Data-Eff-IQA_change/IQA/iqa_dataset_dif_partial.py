...
class KONIQDATASET6(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        super(KONIQDATASET6, self).__init__()
...
class LIVECDATASET6(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class LIVEDataset6(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class TID2013Dataset6(data.Dataset):
...
class CSIQDataset6(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class KADIDDataset6(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        refpath = os.path.join(root, "reference_images")
...
class SPAQDATASET6(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        super(SPAQDATASET6, self).__init__()
...
class FBLIVEFolder6(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        imgname = []
        mos_all = []
