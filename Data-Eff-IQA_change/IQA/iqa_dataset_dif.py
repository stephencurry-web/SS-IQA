...
class KONIQDATASET5(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        super(KONIQDATASET5, self).__init__()
...
class LIVECDATASET5(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class LIVEDataset5(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class TID2013Dataset5(data.Dataset):
...
class CSIQDataset5(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class KADIDDataset5(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        refpath = os.path.join(root, "reference_images")
...
class SPAQDATASET5(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        super(SPAQDATASET5, self).__init__()
...
class FBLIVEFolder5(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        imgname = []
        mos_all = []
