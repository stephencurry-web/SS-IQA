...
class KONIQDATASET8(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        super(KONIQDATASET8, self).__init__()
...
class LIVECDATASET8(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class LIVEDataset8(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class TID2013Dataset8(data.Dataset):
...
class CSIQDataset8(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
...
class KADIDDataset8(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        refpath = os.path.join(root, "reference_images")
...
class SPAQDATASET8(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        super(SPAQDATASET8, self).__init__()
...
class FBLIVEFolder8(data.Dataset):
    def __init__(self, root, index, patch_num, transform=None):
        imgname = []
        mos_all = []
