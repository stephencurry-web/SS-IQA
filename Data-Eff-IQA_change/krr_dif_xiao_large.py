...
def main(config, i):
    ...
    for slice_num in range(config.DATA.SLICE_NUMBER):
        ...
        pseudo_label = get_krr_label(t_model, data_loader_train_ex1, len(dataset_train_A),
        ...
        if slice_num < config.DATA.SLICE_NUMBER-1:
            ...
            for i in range(slice_num+1):
                ...
                pseudo_label_examplar = get_krr_label(t_model, data_loader_train_ex1, len(dataset_train_A),
                                                           dataset_train2_teacher, config.DATA.BATCH_SIZE1, logger)
