...
def main(config, save_num):
    ...
    # 416
    regressor = KernelRidge(kernel='rbf', gamma=0.001)
    regressor = get_regressor(t_model, regressor, data_loader_train_ex1, len(dataset_train_A),
...
if __name__ == "__main__":
    ...
    for i in range(num):
        ...
        config.defrost()
        config.SET.TRAIN_INDEX = sel_num[0: int(round(0.6 * len(sel_num)))]
