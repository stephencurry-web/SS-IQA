...
def main(config, i):
    ...
    if len(dataset_train_A) > 50000:
        # for give label
        partial_dataset_train_A = []
        partial_dataset_train_A = get_random_examplar(partial_dataset_train_A, dataset_train_A, 4)
    ...
    for slice_num in range(config.DATA.SLICE_NUMBER):
        ...
        pseudo_label_data = get_krr_label(t_model, partial_data_loader_train_ex1, len(partial_dataset_train_A),
        ...
        if slice_num < config.DATA.SLICE_NUMBER-1:
            ...
            pseudo_label_data_examplar = get_krr_label(t_model, partial_data_loader_train_ex1, len(partial_dataset_train_A),
            ...
            examplar_total = get_A_examplar1(examplar_total, pseudo_label_data_examplar, data_loader_train_ex2, t_model, config.DATA.EXAMPLAR_STEP1, logger)
