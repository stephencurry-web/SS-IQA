...
class Experts_MOS(nn.Module):
    def __init__(
        ...
        self.linear = nn.Linear(embed_dim, int(embed_dim / 2), bias=False)
        self.heads = nn.Linear(int(embed_dim / 2), 1, bias=False)
    ...
    def forward(self, x, ref):
        ...
        return x.view(B, 1), torch.mean(feat, dim=1)


# 相比Block多了gamma_1和gamma_2
...
if __name__ == "__main__":
    vit = build_vit_pws(
        pretrained=True,
        pretrained_model_path="/home/pws/IQA/Data-Eff-IQA/deit_3_small_224_1k.pth",
    )
