...
from models import build_model, build_model_pws1, get_krr_label
...
from examplar import get_A_examplar1
...
def main(config, i):
    ...
    examplar_total = get_A_examplar1(examplar_total, dataset_train_A, data_loader_train_ex1, s_model, config.DATA.EXAMPLAR_STEP, logger)
    ...
    for slice_num in range(config.DATA.SLICE_NUMBER):
        ...
        pseudo_label_data = get_krr_label(s_model, data_loader_train_ex1, len(dataset_train_A),
        ...
        if slice_num < config.DATA.SLICE_NUMBER-1:
            ...
            pseudo_label_data_examplar = get_krr_label(s_model, data_loader_train_ex1, len(dataset_train_A),
            ...
            examplar_total = get_A_examplar1(examplar_total, pseudo_label_data_examplar, data_loader_train_ex2, s_model, config.DATA.EXAMPLAR_STEP1, logger)
